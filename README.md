...
> *Краткое описание: Научная работа. Анализ большого объёма данных с новостного форума.*
- **Основной stack:** === В разработке ===
- **Результат:** === В разработке ===


## Мой бэкграунд
- Ранее выполнял небольшие личные/учебные проекты по FastAPI
- Работал UI/UX дизайнером

> Бэкграунд связанный с FastAPI помогает сделать инференс для моих моделей, а опыт UI/UX дизайнера делает этот инференс красивее :)
